...
public class ParabolaController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Animation && parabolaFly != null && animationTime < parabolaFly.GetDuration())
        {
            ...
            {
                if (parabolaFly.IsFinished(this.transform, target.transform))
                {
                    finish.Invoke();
                    return;
                }
    ...
    public class ParabolaFly
    {
        ...
        public bool  IsFinished(Transform obj, Transform target)
        {
            if (obj.transform.position == target.position) return true;
            return false;
        }
